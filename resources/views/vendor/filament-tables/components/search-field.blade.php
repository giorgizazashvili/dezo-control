...
>
    ...
    <button
        type="button"
        class="fi-icon-btn fi-size-lg"
        style="margin: 0; flex-shrink: 0; width: 3.5rem; height: 3.5rem;"
        @click="openScanner()"
        title="QR სკანირება"
    >
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="fi-icon" style="width: 2.25rem; height: 2.25rem;">
