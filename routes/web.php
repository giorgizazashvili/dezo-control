...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/print/qr-placement/{movement}/a4', function (\App\Models\Movement $movement) {
        $movementService = app(\App\Services\MovementService::class);
        ...
        return view('print.qr-placement-a4', compact('items'));
    })->name('print.qr-placement-a4');
